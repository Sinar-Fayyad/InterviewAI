...
export default function CoverLetter() {
  ...
  const [coverLetterType, setCoverLetterType] =
    useState<CoverLetterType>("Solicited");
  ...
  const handleFileUpload = async (file: File | null) => {
    ...
    try {
      ...
      toast({
        title: "File Uploaded",
        description: `Text extracted from ${file.name} successfully.`,
      });
    } catch {
      toast({
        title: "Extraction Failed",
        description:
          "Could not extract text from the PDF. Please paste your text manually.",
        variant: "destructive",
      });
  ...
  const handleGenerateCoverLetter = async () => {
    ...
    if (!jobTitle.trim()) {
      toast({
        title: "Missing Information",
        description: "Please enter the job title/position.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (coverLetterType === "Solicited" && !platform.trim()) {
      toast({
        title: "Missing Information",
        description: "Please enter the platform where you saw the job opportunity.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (!userId) {
      toast({
        ...
        description: "Please log in before generating a cover letter.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      const result = await generateCoverLetter(userId, {
        ...
        platform: coverLetterType === "Solicited" ? platform.trim() : "",
        job_description:
          coverLetterType === "Solicited" ? jobDescription.trim() : "",
      ...
      toast({
        ...
        description: `Your ${coverLetterType} cover letter for ${companyName} is ready!`,
      });
    } catch (error: any) {
      toast({
  ...
  const handleDownloadPdf = async (filename: string) => {
    if (!generatedCoverLetter.trim()) {
      toast({
        ...
        description: "There is no cover letter content to download.",
        variant: "destructive",
      });
      return;
    }
    ...
    toast({
      title: "Downloaded",
      description: "Cover letter has been downloaded as PDF.",
    });
  };
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-muted-foreground mb-6">
                  Create a personalized cover letter for your target company using AI
                </p>
              ...
              >
                ...
                <p className="text-muted-foreground mb-6">
                  Enhance your current cover letter with AI-powered suggestions
                </p>
            ...
            <div className="flex flex-col gap-8">
              <Card className="bg-secondary/80 border-primary/20 shadow-card p-8 max-w-3xl mx-auto w-full">
                ...
                <p className="text-muted-foreground mb-6 text-center">
                  Fill in the details below to generate your cover letter.
                </p>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setCoverLetterType(e.target.value as CoverLetterType)
                      }
                      className="w-full h-10 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                    >
                      <option value="Solicited">
                        Solicited (Responding to a job posting)
                      </option>
                      <option value="Unsolicited">
                    ...
                    <>
                      <div className="space-y-2">
                        <Label htmlFor="platform" className="flex items-center gap-2">
                          ...
                          Platform / Where You Saw the Job *
                        </Label>
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-xl text-muted-foreground">
              Upload a PDF or paste your text to get AI-powered optimization
            </p>
          </div>
          ...
          <Card className="p-8 max-w-3xl mx-auto">
            <div className="space-y-6">
              ...
              <Textarea
                ...
                disabled={!!coverLetterFile || isExtractingText}
              />
              ...
              <Button
                ...
                className="w-full"
                disabled={
                  (!coverLetterText.trim() && !coverLetterFile) ||
                  isOptimizing ||
                  isExtractingText
                }
            ...
            <Card className="bg-secondary/80 border-primary/20 shadow-card p-6 max-w-2xl mx-auto mt-8">
              ...
              <div className="flex flex-wrap gap-3 mt-4">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => handleDownloadPdf("optimized_cover_letter.pdf")}
                >
                  <Download className="w-4 h-4 mr-2" />
                  Download as PDF
                </Button>
