              ...
              {isEditing || (isNewItem && !isEditing) ? (
                <div className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    <Input 
                      placeholder="Company" 
                      value={isEditing ? editData?.company : exp.company} 
                      onChange={(e) => {
                        if (isEditing) {
                    ...
                    <Input 
                      ...
                      value={isEditing ? editData?.position : exp.position} 
                      onChange={(e) => {
                        if (isEditing) {
                    ...
                    <div className="grid grid-cols-2 gap-2 md:col-span-2">
                      <Input 
                        type="month" 
                        value={isEditing ? editData?.startDate : exp.startDate} 
                        onChange={(e) => {
                          if (isEditing) {
                      ...
                      <Input 
                        type="month" 
                        value={isEditing ? editData?.endDate : exp.endDate} 
                        onChange={(e) => {
                          if (isEditing) {
                  ...
                  <Textarea 
                    ...
                    value={isEditing ? editData?.description : exp.description} 
                    onChange={(e) => {
                      if (isEditing) {
